...
const LABELS: Record<string, string> = {
  exposure_valid:      "Image Enhancement (exposure)",
  histogram_profile:   "Histogram Processing",
  noise_consistency:   "Spatial Filtering (noise quality)",
  ...
  profile_match:       "Colour Space (Lab profile match)",
  color_consistency:   "Colour Space (color consistency)",
